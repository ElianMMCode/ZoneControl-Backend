...
| **Complejidad** | Media |
| **HU Relacionada** | HU-03, HU-18, HU-28, HU-30 |
...
- **Frontend**: ✓ — panel de zonas en `/supervisor/zones` (roles ADMIN y SUPERVISOR_AUDITOR). Entrada vía `/supervisor/validar` (HU-18) y salida vía pestaña Salida (HU-28).

...
| **Complejidad** | Media |
| **HU Relacionada** | HU-05, HU-09, HU-31 |
...
El sistema cuenta con un catálogo de cargos. Cada cargo tiene un nombre único y, opcionalmente, un **rol de sistema** (Administrador, Gestor de Personal o Supervisor / Auditor). El rol de sistema del cargo es la base para decidir si un empleado puede tener usuario del sistema y con qué rol (HU-05).
...
Este catálogo es la única fuente para el campo "cargo" de los empleados: al registrar o editar un empleado (HU-09, HU-31) el cargo se selecciona de aquí, no se escribe libremente.

...
| **Complejidad** | Alta |
| **HU Relacionada** | HU-03, HU-05, HU-06, HU-07, HU-08, HU-28, HU-29 |
...
Una cuenta de usuario nace de un empleado: primero se registra al empleado en Gestión de Personal (HU-08) y se le asigna un **cargo** del catálogo (HU-29). Cada cargo del catálogo define si otorga o no un **rol de sistema** (Administrador, Gestor de Personal o Supervisor / Auditor) y cuál.
...
Si el enlace no se usa dentro de las 24 horas, deja de ser válido y el administrador debe generar uno nuevo (HU-07).
...
- **Relacionado**: el catálogo de cargos (HU-29) define el rol; el gestor asigna el cargo al registrar/editar el empleado (HU-08, HU-28).

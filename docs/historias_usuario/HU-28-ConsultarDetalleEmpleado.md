...
| **Complejidad** | Media |
| **HU Relacionada** | HU-08, HU-13, HU-10, HU-14 |
...
Al editar al empleado, el cargo se selecciona del catálogo de cargos (HU-29) mediante una lista desplegable y, según el cargo elegido, el sistema muestra el rol de sistema que le corresponde al empleado (derivado del cargo, HU-04).
...
Entonces: puede hacerlo desde la misma ficha, con las mismas validaciones que la gestión de permisos (HU-10, HU-12)

# HU-22 - ALERTAS DE ANOMALÍAS DE ACCESO
...
| 1.1 | 2026-08-23 | | | El gestor de personal accede a consulta y marcado de alertas; vista /personal/historial con stream en vivo y enlace al detalle del empleado | |
...
- **Frontend**: ✓ — panel de alertas en `/supervisor/zones`, `SecurityAlertsPanel` en el dashboard del admin (`/admin/dashboard`), en el listado del gestor (`/personal`) y en la vista del gestor `/personal/historial` (que integra además el stream SSE en vivo con los movimientos recientes).
